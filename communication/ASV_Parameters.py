...
ESC_Fwd_Min = 1510 ## = value assigned to ESC for min forward speed
ESC_Rev_Max = 500 ## = value assigned to ESC for max reverse speed
ESC_Rev_Min = 1490 ## = value assigned to ESC for min reverse speed
ESC_Stop = 1500
